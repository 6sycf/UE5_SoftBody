...
public:
    ...
    BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
        SHADER_PARAMETER_RDG_BUFFER_UAV(RWStructuredBuffer<FGPUParticle>, RWParticles)
        SHADER_PARAMETER_RDG_TEXTURE(Texture3D, GlobalDistanceFieldPageAtlasTexture)
        SHADER_PARAMETER_RDG_TEXTURE(Texture3D<uint>, GlobalDistanceFieldPageTableTexture)
